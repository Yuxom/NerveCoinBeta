...
uint256 hashGenesisBlock("0x83fe1c07b66120e8dde472421969c3aa5187d549ceada2fb6ad1aee3ea4fb3f0");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // NerveCoinBeta: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "NerveCoinBeta Signed Message:\n";
...
{
    // NerveCoinBeta: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // NerveCoinBeta: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // NerveCoinBeta: 3.5 days
static const int64 nTargetSpacing = 150; // NerveCoinBeta: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // NerveCoinBeta: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // NerveCoinBeta: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // NerveCoinBeta: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x3e1c2250b974ea68d984e1939d7ec0ceeea5aec384e5030306c1af52bb533c7e");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Snitches Get Stitches";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("b3cfe31e0a20ab0a2b75924e9124dcb2650c3bf80f7c577fdf7f3bfce35b68fe3398bd914c110f1f02ff4331c07af3084a3359decf69d56195f1f0c226d6e6cae2") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1520039257;
        block.nBits    = 504365644;
        block.nNonce   = 1746506010;

        if (fTestNet)
        {
            block.nTime    = 1520039257;
            block.nNonce   = 572654583;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x66275f82b14f59aa52b2eb6ed62f60351d787239c61f774d48824c21c3039cda"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // NerveCoinBeta: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("NerveCoinBetaMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("NerveCoinBetaMiner : ProcessBlock, block not accepted");
    }
